...
function roleAccent(role: string): string {
  switch (role) {
    ...
    case "TECHNICIAN_INTERNAL": return "bg-blue-500/10 text-blue-700 border border-blue-400/30 dark:text-blue-400";
    case "TECHNICIAN_EXTERNAL": return "bg-purple-500/10 text-purple-700 border border-purple-400/30 dark:text-purple-400";
    case "FRONT_DESK": return "bg-emerald-500/10 text-emerald-700 border border-emerald-400/30 dark:text-emerald-400";
