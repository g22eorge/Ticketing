...
const roleOrder: Partial<Record<Role, readonly string[]>> = {
  ADMIN: [
    ...
    // inventory
    "/inventory", "/inventory/locations", "/inventory/transfers", "/inventory/goods-received", "/inventory/purchase-requests", "/inventory/supplier-bills", "/inventory/suppliers", "/inventory/purchase-orders",
    // clients
    "/clients", "/sales", "/pos",
    // documents
