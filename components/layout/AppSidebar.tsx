...
const roleOrder: Partial<Record<Role, readonly string[]>> = {
  ADMIN: [
    ...
    "/finance/expenses", "/finance/tax-rates", "/finance/recurring", "/pos/shifts", "/targets", "/reports", "/payout-followups",
    "/settings",
  ],
  MANAGER: [
    "/dashboard",
  ...
  OPS: [
    ...
    "/clients", "/sales", "/pos",
    "/documents/job-cards", "/documents/quotations", "/documents/invoices", "/documents/receipts", "/documents/delivery-notes", "/documents/credit-notes", "/documents/refunds",
    "/finance/expenses", "/finance/recurring", "/pos/shifts", "/targets", "/reports", "/payout-followups",
    "/settings",
  ],
  FINANCE: [
    "/dashboard",
