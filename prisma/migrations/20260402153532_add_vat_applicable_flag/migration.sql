...
INSERT INTO "new_Job" ("accessories", "approvalDate", "assignedToId", "brand", "clientApproved", "clientConversationNote", "clientId", "closedAt", "communicationStatus", "completedAt", "costEstimate", "createdById", "deviceType", "diagnosisNotes", "externalDiagnosis", "externalPaid", "externalPaidAt", "externalPaidById", "externalPaymentRef", "externalTechFee", "finalCost", "id", "issueDescription", "jobNumber", "lastClientContactAt", "model", "partsNeeded", "partsReplaced", "physicalNotes", "quotedAt", "receivedAt", "recommendationOption", "recommendedRepair", "repairPath", "repairTimeline", "serialOrImei", "status", "technicianNotes", "timelineConfidence", "timelineMaxMinutes", "timelineMinMinutes", "timelineNote", "updatedAt", "workDone") SELECT "accessories", "approvalDate", "assignedToId", "brand", "clientApproved", "clientConversationNote", "clientId", "closedAt", "communicationStatus", "completedAt", "costEstimate", "createdById", "deviceType", "diagnosisNotes", "externalDiagnosis", "externalPaid", "externalPaidAt", "externalPaidById", "externalPaymentRef", "externalTechFee", "finalCost", "id", "issueDescription", "jobNumber", "lastClientContactAt", "model", "partsNeeded", "partsReplaced", "physicalNotes", "quotedAt", "receivedAt", "recommendationOption", "recommendedRepair", "repairPath", "repairTimeline", "serialOrImei", "status", "technicianNotes", "timelineConfidence", "timelineMaxMinutes", "timelineMinMinutes", "timelineNote", "updatedAt", "workDone" FROM "Job";
DROP TABLE "Job";
