...
INSERT INTO "new_Job" ("accessories", "approvalDate", "assignedToId", "brand", "clientApproved", "clientId", "closedAt", "completedAt", "costEstimate", "createdById", "deviceType", "diagnosisNotes", "externalDiagnosis", "finalCost", "id", "issueDescription", "jobNumber", "model", "partsNeeded", "partsReplaced", "physicalNotes", "quotedAt", "receivedAt", "recommendedRepair", "repairPath", "repairTimeline", "serialOrImei", "status", "technicianNotes", "timelineConfidence", "timelineMaxMinutes", "timelineMinMinutes", "timelineNote", "updatedAt", "workDone") SELECT "accessories", "approvalDate", "assignedToId", "brand", "clientApproved", "clientId", "closedAt", "completedAt", "costEstimate", "createdById", "deviceType", "diagnosisNotes", "externalDiagnosis", "finalCost", "id", "issueDescription", "jobNumber", "model", "partsNeeded", "partsReplaced", "physicalNotes", "quotedAt", "receivedAt", "recommendedRepair", "repairPath", "repairTimeline", "serialOrImei", "status", "technicianNotes", "timelineConfidence", "timelineMaxMinutes", "timelineMinMinutes", "timelineNote", "updatedAt", "workDone" FROM "Job";
DROP TABLE "Job";
