...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    // Shared full prop object used by all repair document templates
    const sharedRepairProps = {
      ...company,
      ...
      workDone:          SAMPLE.scopeOfWork,
      partsReplaced:     SAMPLE.partsNeeded,
    ...
    if (kind === "INVOICE") {
      ...
      element = createElement(Comp as never, sharedRepairProps);
