    ...
    <div className="space-y-4">
      <div className="panel-shadow flex flex-wrap items-center justify-between gap-2 rounded-xl border border-[var(--line)] bg-[var(--panel)] px-4 py-2.5">
        <div>
          ...
          <p className="mt-1 text-[13px] font-bold text-[var(--ink)]">Supplier Bills <span className="font-normal text-[var(--ink-muted)]">· {bills.length}</span></p>
        </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            ...
            <tbody>
              ...
              {bills.length === 0 ? <tr><td colSpan={7} className="px-4 py-10 text-center text-sm text-[var(--ink-muted)]">No supplier bills yet.</td></tr> : null}
            </tbody>
          </table>
        </div>
      </div>
