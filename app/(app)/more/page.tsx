...
function NavRow({
  ...
  return (
    <Link
      href={href}
      className="flex items-center gap-3.5 px-4 py-3.5 transition-colors active:bg-[var(--panel-strong)] hover:bg-[var(--panel-strong)]/60"
    >
      {/* Icon circle */}
      ...
      <div className="min-w-0 flex-1">
        <p className="text-[14px] font-semibold text-[var(--ink)] leading-snug">{label}</p>
        {description && (
          <p className="text-[11px] text-[var(--ink-muted)] leading-tight mt-0.5">{description}</p>
        )}
      </div>
      ...
      <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor"
        ...
        className="shrink-0 text-[var(--ink-muted)]/40" aria-hidden="true">
    ...
    <div className="pb-6">
      ...
      <div className="divide-y divide-[var(--line)]/50 rounded-2xl border border-[var(--line)] bg-[var(--panel)] mx-2 overflow-hidden">
        ...
        {can.viewClientInfo(perm) && (
          <NavRow href="/clients" label="Clients"
        ...
        {["ADMIN","OPS","TECHNICIAN_INTERNAL","MANAGER"].includes(user.role) && ok("INVENTORY") && (
          <NavRow href="/inventory" label="Inventory"
        ...
        {user.role !== "TECHNICIAN_EXTERNAL" && (
          <NavRow href="/technicians" label="Technicians"
        ...
        {["ADMIN","OPS","MANAGER"].includes(user.role) && (
          <NavRow href="/inventory/suppliers" label="Suppliers"
        ...
        {ok("COMPLAINTS") && ["ADMIN","MANAGER","TECH_MANAGER","OPS"].includes(user.role) && (
          <NavRow href="/complaints" label="Complaints"
        ...
        {can.createLeads(perm) && ok("SALES") && (
          <NavRow href="/sales" label="Sales & Leads"
      ...
      {can.viewFinancials(perm) && (
        <>
          ...
          <div className="divide-y divide-[var(--line)]/50 rounded-2xl border border-[var(--line)] bg-[var(--panel)] mx-2 overflow-hidden">
            ...
            {ok("INVOICING") && (
              <>
                <NavRow href="/documents/job-cards" label="Job Cards"
                ...
                />
                <NavRow href="/documents/quotations" label="Quotations"
                ...
                />
                <NavRow href="/documents/invoices" label="Invoices"
                ...
                />
                <NavRow href="/documents/receipts" label="Receipts"
                ...
                />
                <NavRow href="/documents/delivery-notes" label="Delivery Notes"
      ...
      {["ADMIN","OPS","FRONT_DESK","MANAGER"].includes(user.role) && ok("POS") && (
        <>
          ...
          <div className="divide-y divide-[var(--line)]/50 rounded-2xl border border-[var(--line)] bg-[var(--panel)] mx-2 overflow-hidden">
            <NavRow href="/pos" label="Point of Sale"
            ...
            {["ADMIN","OPS","FRONT_DESK","MANAGER"].includes(user.role) && (
              <NavRow href="/pos/shifts" label="Cashier Shifts"
        ...
        <>
          ...
          <div className="divide-y divide-[var(--line)]/50 rounded-2xl border border-[var(--line)] bg-[var(--panel)] mx-2 overflow-hidden">
            ...
            {can.manageUsers(perm) && (
              <NavRow href="/settings/users" label="Users & Roles"
            ...
            {["ADMIN","MANAGER"].includes(user.role) && (
              <NavRow href="/settings/branches" label="Branches"
            ...
            {can.viewAccountsSummary(perm) && (
              <NavRow href="/reports" label="Reports"
            ...
            {["ADMIN"].includes(user.role) && (
              <NavRow href="/settings/data-heal" label="Backup & Restore"
      ...
      <div className="divide-y divide-[var(--line)]/50 rounded-2xl border border-[var(--line)] bg-[var(--panel)] mx-2 overflow-hidden">
        <NavRow href="/settings/notifications" label="Notifications"
        ...
        />
        <NavRow href="/settings/profile" label="My Profile"
