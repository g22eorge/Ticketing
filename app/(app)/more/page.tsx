  ...
  return (
    <div className="pb-6">
      ...
      <p className="mt-6 px-4 text-center text-[12px] text-[var(--ink-muted)]/40">
        Techserve ICT Solutions v{APP_VERSION}
      </p>
